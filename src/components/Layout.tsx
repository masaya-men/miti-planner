...
export const Layout: React.FC<LayoutProps> = ({ children }) => {
    ...
    return (
        <div className="flex bg-app-bg min-h-screen font-sans text-app-text selection:bg-app-accent/20 transition-colors duration-300">
            <div className="flex-1 flex flex-col min-w-0">
                ...
                {/* Main Content */}
                <main className="flex-1 pt-14 relative overflow-hidden bg-app-bg transition-colors duration-300">
                    {children}
                </main>
            </div>
        </div>
