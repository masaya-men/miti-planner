        ...
        <>
            <div className="flex flex-col h-full w-full bg-transparent px-6 pt-2 pb-6 overflow-auto relative">
                ...
                <div className="relative flex-1 flex flex-col pt-0 glass-panel rounded-xl overflow-hidden shadow-2xl border border-white/5">
                    ...
                    <div className={clsx(
                        "flex-shrink-0 z-50 bg-[#0a0a0c]/40 backdrop-blur-xl border-b border-white/10 text-[11px] font-barlow font-medium text-app-text-muted uppercase tracking-wider text-center h-10 flex items-center shadow-lg select-none"
                    )}>
