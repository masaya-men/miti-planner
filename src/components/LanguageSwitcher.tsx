        ...
        <div className="flex items-center bg-[rgba(var(--app-accent-rgb),0.08)] dark:bg-[rgba(var(--app-accent-rgb),0.06)] rounded-full pl-2 pr-1 py-1 border border-[rgba(var(--app-accent-rgb),0.3)] dark:border-[rgba(var(--app-accent-rgb),0.25)] relative h-[32px] select-none shadow-[0_0_8px_rgba(var(--app-accent-rgb),0.15)] group transition-colors hover:border-[rgba(var(--app-accent-rgb),0.5)]">
            ...
            <div className="flex relative w-[80px] h-full items-center">
                ...
                <button
                    ...
                    className={`flex-1 relative z-10 text-[10px] font-black transition-colors duration-200 flex items-center justify-center cursor-pointer ${currentLang === 'ja' ? 'text-app-accent drop-shadow-[0_0_6px_rgba(var(--app-accent-rgb),0.6)]' : 'text-app-text'
                        }`}
                >
                    JP
                </button>
                <button
                    ...
                    className={`flex-1 relative z-10 text-[10px] font-black transition-colors duration-200 flex items-center justify-center cursor-pointer ${currentLang === 'en' ? 'text-app-accent drop-shadow-[0_0_6px_rgba(var(--app-accent-rgb),0.6)]' : 'text-app-text'
                        }`}
                >
                    EN
                </button>
