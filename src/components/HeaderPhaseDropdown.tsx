        ...
        >
                ...
                {phases.length === 0 ? (
                    ...
                    phases.map((phase, index) => (
                        <button
                            ...
                            className="w-full px-3 py-2.5 text-left text-[13px] text-app-text hover:bg-glass-hover border-b border-glass-border last:border-b-0 cursor-pointer transition-colors"
                        >
                            {phase.name.split('\n').join(' ')}
                        </button>
                    ))
            ...
            <div className="border-t border-glass-border">
                <button
                    ...
                    className="w-full px-3 py-2.5 text-left text-[11px] text-app-text-muted hover:bg-glass-hover cursor-pointer transition-colors flex items-center gap-2"
                >
