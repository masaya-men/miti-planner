                    ...
                    <div className="p-5 flex-1 overflow-y-auto">
                        <div className="mb-4">
                            ...
                            <p className="text-xs text-slate-500 mb-2">
                                Example: <span className="font-mono text-slate-300">0:15, Raidwide, 120000, magical, PT</span><br />
                        ...
                        <textarea
                            ...
                            className="w-full h-48 bg-black/40 border border-white/10 rounded-xl p-3 text-sm font-mono text-slate-300 focus:outline-none focus:border-blue-500/50 focus:ring-1 focus:ring-blue-500/50 resize-none placeholder:text-slate-600"
