...
export const MITIGATIONS: Mitigation[] = [
    ...
    },
    {
        ...
        recast: 120, duration: 15, type: "all", value: 40, isShield: false, scope: "self", family: "tank_40"
    },
    {
    ...
    },
    {
        ...
        recast: 90, duration: 30, type: "all", value: 0, isShield: true, scope: "party", family: "tank_party_miti"
    },
    {
    ...
    // --- Pictomancer ---
    {
        ...
        recast: 90, duration: 10, type: "all", value: 0, isShield: true, family: "caster_personal_shield"
    },
    ...
    },
    {
        ...
        recast: 300, duration: 10, type: "all", value: 0, isShield: false, note: "HP減少無視", scope: "self", isInvincible: true, family: "tank_invuln"
    },
    {
        id: "oblation", jobId: "drk", name: { ja: "オブレーション", en: "Oblation" }, icon: "/icons/Oblation.png",
        recast: 60, duration: 10, type: "all", value: 10, isShield: false, scope: "self", maxCharges: 2, family: "tank_sub_targeted"
    },
    {
    ...
    },
    {
        ...
        recast: 15, duration: 7, type: "all", value: 0, isShield: true, scope: "self", family: "tank_short"
    },

    // --- Scholar ---
    {
        id: "accession", jobId: "sch", name: { ja: "アクセッション", en: "Accession" }, icon: "/icons/Accession.png",
        recast: 2.5, duration: 30, type: "all", value: 0, isShield: true, requires: "seraphism", family: "healer_gcd_shield"
    },
    {
        id: "concitation", jobId: "sch", name: { ja: "意気軒高の策", en: "Concitation" }, icon: "/icons/Concitation.png",
        recast: 2.5, duration: 30, type: "all", value: 0, isShield: true, family: "healer_gcd_shield"
    },
    {
        id: "consolation", jobId: "sch", name: { ja: "コンソレイション", en: "Consolation" }, icon: "/icons/Consolation.png",
        recast: 1, duration: 30, type: "all", value: 0, isShield: true, requires: "summon_seraph", maxCharges: 2, family: "bh_sub_a"
    },
    {
        id: "adloquium", jobId: "sch", name: { ja: "鼓舞激励の策", en: "Adloquium" }, icon: "/icons/Adloquium.png",
        recast: 2.5, duration: 30, type: "all", value: 0, isShield: true, family: "healer_gcd_target_shield"
    },
    {
        ...
        recast: 90, duration: 30, type: "all", value: 0, isShield: true, note: "確定クリティカル", family: "bh_90_shield"
    },
    ...
    },
    {
        ...
        recast: 120, duration: 20, type: "all", value: 10, isShield: false, family: "bh_120_b"
    },
    {
    ...
    },
    {
        ...
        recast: 120, duration: 22, type: "all", value: 0, isShield: false, family: "bh_120_a"
    },
    ...
    },
    {
        ...
        recast: 90, duration: 15, type: "all", value: 15, isShield: false, family: "ranged_party_15"
    },
    ...
    },
    {
        ...
        recast: 120, duration: 20, type: "all", value: 10, isShield: true, family: "bh_120_b"
    },
    {
    ...
    },
    {
        ...
        recast: 2.5, duration: 15, type: "all", value: 0, isShield: false, note: "ニュートラルセクト中のみバリア", requires: "neutral_sect", family: "healer_gcd_shield"
    },
    {
        id: "macrocosmos", jobId: "ast", name: { ja: "マクロコスモス", en: "Macrocosmos" }, icon: "/icons/Macrocosmos.png",
        recast: 180, duration: 15, type: "all", value: 0, isShield: false, family: "ph_180_big"
    },
    {
    ...
    },
    {
        ...
        recast: 1, duration: 15, type: "all", value: 10, isShield: false, requires: "neutral_sect", maxCharges: 1, family: "ph_sub_120"
    },

    // --- Warrior ---
    {
        id: "bloodwhetting", jobId: "war", name: { ja: "原初の血気", en: "Bloodwhetting" }, icon: "/icons/Bloodwhetting.png",
        recast: 25, duration: 8, type: "all", value: 20, isShield: true,
    ...
    },
    {
        ...
        recast: 240, duration: 10, type: "all", value: 0, isShield: false, note: "HP減少無視", scope: "self", isInvincible: true, family: "tank_invuln"
    },
    {
    ...
    // --- White Mage ---
    {
        ...
        recast: 1, duration: 10, type: "all", value: 0, isShield: true, requires: "temperance", family: "ph_sub_120"
    },
    {
    ...
    },
    {
        ...
        recast: 120, duration: 20, type: "all", value: 10, isShield: false, family: "ph_120_aoe"
    },

    // --- Dancer ---
    {
        id: "improvisation", jobId: "dnc", name: { ja: "インプロビゼーション", en: "Improvisation" }, icon: "/icons/Improvisation.png",
        recast: 120, duration: 30, type: "all", value: 0, isShield: true, note: "最大HPの5-10%バリア", family: "ranged_party_heal"
    },
    {
    ...
    ...['pld', 'war', 'drk', 'gnb'].map(job => ({
        ...
        recast: 60, duration: 15, type: "all" as const, value: 10, isShield: false, scope: "party" as const, family: "role_action"
    })),
