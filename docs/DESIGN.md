...
> このファイルは UI 作業時に参照する詳細スペック。 即時に守るべき核心ルールは [.claude/rules/DESIGN.md](../.claude/rules/DESIGN.md)。
> 禁止事項は [.claude/rules/ui-design.md](../.claude/rules/ui-design.md)。
...
| 軽減追加列 (T/H) | 0px (非表示) | 126px (固定、 視覚対称) |
| 軽減追加列 (DPS) | 0px (非表示) | 53px (固定、 視覚対称) |
