        ...
        <div className="fixed inset-0 z-[99999] flex items-center justify-center">
            ...
            <div className={clsx(
                ...
                <div className="flex items-center gap-3 px-5 pt-5 pb-2">
                    ...
                    <h3 className="text-[18px] font-black text-app-text tracking-wide">{title}</h3>
                    <button
                        onClick={onCancel}
                ...
                <div className="px-5 py-3">
                    <p className="text-[13px] text-app-text-sec leading-relaxed font-medium whitespace-pre-line">{message}</p>
                </div>
                {/* Footer */}
                <div className="flex items-center justify-end gap-2 px-5 py-4 border-t border-app-border">
                    <button
                        onClick={onCancel}
                        className="px-4 py-2 rounded-xl text-[13px] font-black text-app-text-sec hover:text-app-text hover:bg-app-surface2 transition-colors border border-transparent hover:border-app-border cursor-pointer"
                    >
                        {finalCancelLabel}
                    </button>
                    <button
                        onClick={onConfirm}
                        className={clsx(
                            "px-4 py-2 rounded-xl text-[13px] font-bold text-white transition-all shadow-lg cursor-pointer",
                            variant === 'danger'
