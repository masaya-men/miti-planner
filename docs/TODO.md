...
**Discord告知**: 統合下書き=`docs/.private/2026-08-20-discord-full-update-draft.md`(2026-08-12/08-14の旧下書き2本+08-16以降の未告知分を全部統合、リーパーのアルケインクレストは非表示のため告知文には含めていない)。投稿・`/admin`登録はユーザー側。投稿後、旧4下書きファイルの棚卸しが必要。
