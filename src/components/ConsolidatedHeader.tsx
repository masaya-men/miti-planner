...
export const ConsolidatedHeader: React.FC<ConsolidatedHeaderProps> = ({
    ...
    return (
        ...
        >
            ...
            {/* ログイン / アカウントメニュー（ポータル：overflow-hiddenの外に描画） */}
            {showLoginMenu && createPortal(
                <>
                    ...
                    >
                        ...
                        {user && (
                            <>
                                <div className="px-3 py-2 flex items-center gap-2.5 border-b border-app-border mb-1">
                                    {user.photoURL && (
                        ...
                        {!user && ([
                            ...
                            <button
                                ...
                                className={clsx(
                                    "w-full text-left px-3 py-2 text-[11px] font-bold rounded transition-all duration-300 flex items-center gap-2.5 cursor-pointer",
