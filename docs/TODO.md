...
- **🔴 探す地図フィードバック: ①③④✅ / ②案B実装完了→ユーザー実機確認待ち** (2026-07-12)。詳細=`docs/.private/2026-07-12-browse-map-feedback.md`。①③④コミット済。②実機総点検OK後に main 反映→`firebase deploy --only firestore`(PF rules+indexes先)→push→②ダミー削除。
