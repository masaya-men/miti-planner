...
- **PF設計承認済(2026-07-10)**: 名前=個人タグ一体化 / 項目=名前+アイコン+ひとこと+SNS(許可リスト) / 表示=詳細のみ(人気偏重回避) / 公開プロフィール中央方式。**設計書=`docs/superpowers/specs/2026-07-10-housinger-profile-design.md`**(ユーザー最終レビュー→計画書化へ)。
