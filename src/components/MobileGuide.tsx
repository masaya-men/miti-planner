        ...
        <div className="fixed inset-0 z-[12000] flex items-center justify-center bg-black/50 backdrop-blur-[2px] p-6">
            ...
            >
                ...
                <div className={clsx(
                    ...
                    <span className="text-[11px] font-black text-app-text-muted uppercase tracking-widest">
                ...
                <div className="px-6 py-6 flex flex-col items-center text-center min-h-[180px] relative overflow-hidden">
                    <AnimatePresence mode="wait" custom={direction}>
                        ...
                        >
                            ...
                            <div>
                                <h3 className="text-[18px] font-black text-app-text mb-1.5">
                ...
                <div className={clsx(
                    ...
                    {currentStep > 0 && (
                        <button
                            onClick={handlePrev}
                            className={clsx(
                                "flex-1 py-2.5 rounded-xl text-[13px] font-bold transition-all cursor-pointer",
