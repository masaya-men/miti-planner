        ...
        <div className="fixed inset-0 z-[99999] flex items-center justify-center">
            ...
            style={{ '--glass-tier3-bg': 'var(--share-modal-bg)' } as React.CSSProperties}>
                ...
                <div className="px-5 py-3">
                    <p className="text-app-lg text-app-text-sec leading-relaxed font-medium whitespace-pre-line">{message}</p>
                </div>
                {/* Footer */}
                <div className="flex items-center justify-end gap-2 px-5 py-4 border-t border-app-border">
                    ...
                    <button
                        onClick={onConfirm}
                        className={clsx(
                            "px-4 py-2 rounded-xl text-app-md font-bold text-white transition-all shadow-lg cursor-pointer",
                            variant === 'danger'
