...
- **最新セッション（2026-04-20 後半）**: LP の SEO 改善（レベル 1）完了。index.html / 4 言語 locale / LandingPage.tsx を更新し、「FF14 軽減表」等の検索キーワードをメタタグに反映。多言語対応（ja=軽減表、en=mitigation sheet、ko=경감 시트、zh=减伤轴）。見た目変更なし、build+test 成功。設計書: `docs/superpowers/specs/2026-04-20-lp-seo-meta-multilingual-design.md`
