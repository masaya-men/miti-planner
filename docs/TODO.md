...
- **✅一時ツアー=設計書 完成(2026-07-10)**: spec=`docs/superpowers/specs/2026-07-10-housing-ephemeral-tour-design.md`(ペルソナB=混在ツアー核/入口3箇所/URL+テキスト2方式/揮発・ログイン不要/一時バッジ/登録への橋/一覧非汚染)。計画書化 進行中。
