...
## 次の作業順 (2026-07-01 更新)
1. **ハウジングツアー全機能完成 M1〜M6**(詳細=docs/.private/2026-07-01-housing-tour-rebuild.md)。**地図素材=✅全10マップ完成・保全済**(docs/housing-maps-src/・parse-ward-svgでjson再生成可)。次=**M1(ミストで動くツアー)設計** or 地図データ本体組み込み。参考UI=Downloads/HousingTour_theme。
