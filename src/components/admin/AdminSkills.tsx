                ...
                <div className="flex flex-col h-full min-h-0">
                    <div className="h-full min-h-0 flex gap-4">
                        ...
                        <div className="flex-1 min-h-0 border border-app-text/10 rounded flex flex-col">
                            <div className="shrink-0 p-2 border-b border-app-text/10 flex items-center justify-between">
                                ...
                                {selectedJobId && (
                                    <button
                                        ...
                                        className="px-3 py-1 text-app-lg bg-app-toggle text-app-toggle-text rounded hover:opacity-90 transition-opacity font-bold"
                                    >
                                        + スキル追加
                                    </button>
                                )}
