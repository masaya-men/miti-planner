  ...
  return (
    <section ref={sectionRef} className="h-screen w-full flex items-center justify-center overflow-hidden relative">
      <div className="relative flex flex-col items-center text-center px-6" style={{ zIndex: 20 }}>
        ...
        <p ref={subRef} className="text-app-2xl md:text-app-2xl-plus text-white/35 mb-10 max-w-md opacity-0">
          {t('portal.cta.sub')}</p>
        <button ref={buttonRef} onClick={() => navigate('/miti')}
          className="group relative px-12 py-4 bg-white text-black rounded-lg text-app-2xl font-black overflow-hidden transition-all duration-300 active:scale-95 opacity-0">
        ...
        <div ref={kofiRef} className="mt-7 text-app-lg text-white/20 opacity-0">
