...
import { stepStatus, isMistPlaceable, type TourStep } from '../../../lib/housing/tourNav';
 ...
 * そのまま使う。listing 欠落 (steps.missing) と非ミスト (steps.map_pending・
    ...
    <div className="housing-tour-steps">
      ...
      <ol className="housing-tour-steps-list">
        {steps.map((step, index) => {
          ...
          const mapPending = !missing && !isMistPlaceable(step.listing);
