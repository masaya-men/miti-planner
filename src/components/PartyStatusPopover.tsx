            ...
            >
                ...
                <div className="flex justify-between items-center px-5 py-4 border-b border-glass-border bg-glass-header flex-shrink-0">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h2 className="text-[15px] font-bold text-app-text tracking-wider">{t('party.settings_title', 'パラメータ設定')}</h2>
                            <p className="text-[11px] text-app-text-sec mt-0.5 whitespace-pre-line">
                ...
                <div className="p-4 flex-1 space-y-4">
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="bg-glass-card border border-glass-border rounded-xl p-4 shadow-sm">
                            <div className="flex items-center justify-between">
                                <div className="flex items-center gap-2">
                                    ...
                                    <h4 className="text-[13px] font-bold text-blue-700 dark:text-blue-100 uppercase tracking-wider">TANK</h4>
                                </div>
                                <div className="flex items-center gap-3">
                                    <label className="text-[11px] uppercase tracking-wider text-app-text font-bold">HP</label>
                                    <FormattedNumberInput
                                        value={tankRep?.stats.hp || 0}
                                        onChange={(val) => updateTankHP(val)}
                                        className="w-24 bg-app-surface2 border border-app-border rounded-lg px-2 py-1 text-right text-app-text font-mono text-[13px] hover:border-app-border focus:border-app-accent focus:bg-app-surface2 focus:ring-1 focus:ring-app-accent/30 transition-all"
                                    />
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-glass-card border border-glass-border rounded-xl p-4 shadow-sm">
                            <div className="flex items-center gap-2 mb-3">
                                ...
                                <h4 className="text-[13px] font-bold text-green-700 dark:text-green-100 uppercase tracking-wider">HEALER</h4>
                            </div>
                            <div className="grid grid-cols-2 gap-x-4 gap-y-2">
                                <div className="flex items-center justify-between">
                                    ...
                                    <FormattedNumberInput
                                        ...
                                        className="w-20 bg-app-surface2 border border-app-border rounded-lg px-2 py-1 text-right text-app-text font-mono text-[13px] hover:border-app-border focus:border-app-accent focus:bg-app-surface2 focus:ring-1 focus:ring-app-accent/30 transition-all"
                                    />
                                </div>
                                <div className="flex items-center justify-between">
                                    <label className="text-[11px] uppercase tracking-wider text-app-text font-bold">WD</label>
                                    <FormattedNumberInput
                                ...
                                <div className="flex items-center justify-between">
                                    <label className="text-[11px] uppercase tracking-wider text-app-text font-bold">MND</label>
                                    <FormattedNumberInput
                                ...
                                <div className="flex items-center justify-between">
                                    <label className="text-[11px] uppercase tracking-wider text-app-text font-bold">DET</label>
                                    <FormattedNumberInput
                    ...
                    <div className="pt-2">
                        <h4 className="text-[13px] uppercase tracking-widest text-app-text font-bold mb-2">{t('settings.shield_preview', 'シールド・ヒール量 プレビュー')}</h4>

                        <div className="space-y-3">
                            {/* Top Row: Tank (4 cols) and DPS (2 cols) */}
                            <div className="flex gap-2">
                                <div className="flex-[4]">
                                    <h5 className="text-[11px] font-extrabold text-blue-700 dark:text-blue-300 mb-1">TANK</h5>
                                ...
                                <div className="flex-[2]">
                                    <h5 className="text-[11px] font-extrabold text-red-700 dark:text-red-300 mb-1">DPS</h5>
                            ...
                            <div>
                                <h5 className="text-[11px] font-extrabold text-green-700 dark:text-green-300 mb-1">HEALER</h5>
