                                    ...
                                    {contentLabel && (
                                        <span
                                            className={clsx(
                                                ...
                                                i18n.language.startsWith('ja') ? "text-[24px] font-black" : "text-[24px] font-black"
                                            )}
                                            style={{
                                ...
                                >
                                    {user?.photoURL ? (
                                        ...
                                        <div className="w-6 h-6 rounded-full bg-app-text/15 flex items-center justify-center">
                                            <span className="text-[13px] font-black text-app-text">{(user.displayName || 'U').charAt(0).toUpperCase()}</span>
                                        </div>
                                    ) : (
                                        <LogIn size={16} />
                                    )}
                    ...
                    <div className="h-12 flex items-center justify-between px-6 shrink-0">
                        <div className="flex items-center gap-1.5">
                            ...
                            >
                                ...
                                <span className="text-[13px] font-black uppercase tracking-[0.1em]">{t('party.comp_short')}</span>
                            </button>
                            ...
                            >
                                ...
                                <span className="text-[13px] font-black uppercase tracking-[0.1em]">{t('settings.config_short')}</span>
                            </button>
                            ...
                            >
                                ...
                                <span className="text-[13px] font-black uppercase tracking-[0.1em]">{t('mitigation.auto_plan')}</span>
                            </button>
                        ...
                        <div className="flex items-center gap-1.5">
                            ...
                            >
                                ...
                                <span className="text-[13px] font-black uppercase tracking-[0.1em]">{t('popular.open_popular')}</span>
                            </button>
                            ...
                            >
                                ...
                                <span className="text-[13px] font-black uppercase tracking-[0.1em]">{t('ui.highlight_my_job')}</span>
                            </button>

                            <div className="h-5 w-[1px] dark:bg-app-text/25 bg-app-text mx-0.5 rounded-full" />

                            {/* Sort */}
                            <span className="text-[11px] font-black text-app-text uppercase tracking-[0.15em]">{t('ui.sort')}</span>
                            <div className="flex h-9 rounded-full p-[3px] border border-app-border">
                                {(['light_party', 'role'] as const).map((order) => (
                                    <button
                                        ...
                                        className={clsx(
                                            "px-3 h-full rounded-full text-[11px] font-black uppercase tracking-wider transition-all duration-300 cursor-pointer",
