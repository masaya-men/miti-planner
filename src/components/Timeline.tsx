        ...
        <>
                    ...
                    >
                        <div id="timeline-controls-inner" className="flex items-center gap-0 shrink-0 h-full w-full md:w-max md:min-w-max will-change-transform">
                            ...
                            <div className="flex-none md:w-[200px] md:min-w-[200px] flex items-center gap-0.5 border-l border-white/5 pl-2 h-full">
                                <Tooltip content={t('timeline.undo')} position="bottom">
                                    <button
                                ...
                                <Tooltip content={t('timeline.redo')} position="bottom">
                                    <button
                                ...
                                <div className="relative">
                                    <Tooltip content={t('timeline.clear_mitigations')} position="bottom">
                                        <button
                            ...
                            {(() => {
                                ...
                                return schMembers.map(({ member, idx }) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            <Tooltip content={isPatternOne ? t('timeline.dissipation_to_post') : t('timeline.post_to_dissipation')} position="top">
                                                <button
                    ...
                    >
                        <div id="timeline-header-inner" className="flex items-center h-full w-full md:w-max md:min-w-max will-change-transform">
                            ...
                            {sortedPartyMembers.map((member, index) => (
                                ...
                                >
                                    <Tooltip content={`${member.id} (${t('ui.change_job')})`} position="right">
                                    <div
                                        className={clsx(
            ...
            {clipboardEvent && (
                <div className="fixed bottom-8 left-1/2 -translate-x-1/2 z-[5000] bg-blue-600/90 text-white px-5 py-2.5 rounded-full shadow-[0_0_20px_rgba(37,99,235,0.4)] backdrop-blur-md flex items-center gap-3 animate-in slide-in-from-bottom-5 fade-in duration-200 border border-blue-400/50">
                    ...
                    <Tooltip content={t('timeline.cancel_copy')} position="top">
                        <button
                                        ...
                                        {partyMembers.map(m => {
                                            ...
                                            return (
                                                <button key={m.id} onClick={() => setMobileMitiFlow(prev => ({ ...prev, step: 'skill', selectedMemberId: m.id }))} className={clsx(
                                                    ...
                                                    "bg-slate-50 border-slate-200 active:bg-blue-100 dark:bg-white/5 dark:border-white/10 dark:active:bg-blue-500/30"
                                                )}>
